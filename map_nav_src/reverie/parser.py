...
def parse_args():
    ...
    parser.add_argument('--depth_feat_size', type=int, default=2048)
...
def postprocess_args(args):
    ...
    ft_file_map = {
        ...
        'clip': 'pth_clip_vit_l_14_336px.hdf5',
        'depth': 'depth-glb.hdf5',
        'sem': 'blip2-flanT5-sem.hdf5',
    }
    # /dev/shm/zxs/datasets/R2R/features/blip2-flanT5-sem.hdf5
    # /dev/shm/zxs/datasets/R2R/features/depth-glb.hdf5
    # depth-test.hdf5

    args.img_ft_file = os.path.join(ROOTDIR, 'R2R', 'features', ft_file_map[args.features])
    args.depth_ft_file = os.path.join(ROOTDIR, 'R2R', 'features', ft_file_map['depth'])
    args.sem_ft_file = os.path.join(ROOTDIR, 'R2R', 'features', ft_file_map['sem'])
