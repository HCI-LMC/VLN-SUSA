...
# bertpath = '/dev/shm/zxs/bert-base-uncased'
bertpath = '/data/zxs/Matterport3DSimulator/VLN-DUET/bert-base-uncased'
...
def get_vlnbert_models(args, config=None):
    ...
    vis_config.depth_feat_size = args.depth_feat_size
